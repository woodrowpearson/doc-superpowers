...
Independent of hooks, you can vendor `doc-tools.sh` itself into a consumer repo:
...
| `/doc-superpowers hooks install [--git] [--claude] [--ci] [--all] [--workflows=<csv\|all\|none>] [--helpers=<bool>] [--force]` | Install workflow hooks (granular CI selection + state-respect) |
