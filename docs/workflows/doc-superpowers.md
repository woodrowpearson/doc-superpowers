...
flowchart LR
  ...
  subgraph S3["Phase 3: Generation"]
    ...
    H --> I["Generate co-located diagrams"]
    I --> J["build-index → .doc-index.json"]
    J --> K["Update CLAUDE.md"]
    K --> K2["Sync README.md"]
  end
  subgraph S4["Phase 4: Verification"]
    K2 --> L["Verify freshness markers"]
...
13. Suggest: "Run `/doc-superpowers update` to apply fixes from this audit."
