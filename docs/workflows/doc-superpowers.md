...
| CI/CD | `--ci` | 7 workflows: 3 shell-based (PR freshness check, weekly audit, doc-index auto-update) + 4 Claude-powered (feature branch audit+update, PR doc review + @claude interactive, release notes drafting, spec compliance verification) |
