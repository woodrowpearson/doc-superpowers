...
The CI tier installs 7 GitHub Actions workflow templates into `.github/workflows/`. The first 3 are shell-based and run without AI. The remaining 4 are Claude-powered and require an `ANTHROPIC_API_KEY` GitHub Actions secret.
