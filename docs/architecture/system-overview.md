...
C4Container
  ...
  Container_Boundary(skill, "doc-superpowers Skill") {
    ...
    Container(doctools, "Freshness Tooling", "scripts/doc-tools.sh", "Bundled shell scripts: build-index, check-freshness, update-index, status")
...
| Discovery | Bash (fd, rg, git, ls) | Auto-detect project structure and tooling |
