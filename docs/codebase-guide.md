...
│           ├── doc-freshness-schedule.yml # Weekly scheduled audit (shell-based)
│           ├── doc-index-update.yml       # Post-merge index sync (shell-based)
...
| CI workflow templates | `scripts/hooks/ci/` — doc-freshness-pr.yml, doc-freshness-schedule.yml, doc-index-update.yml (shell-based); doc-audit-update.yml, doc-review-pr.yml, doc-release.yml, doc-spec-verify.yml (Claude-powered) |
